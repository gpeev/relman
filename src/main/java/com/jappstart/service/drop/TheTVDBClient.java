...
import static com.jappstart.service.drop.EpisodeListUtilities.filterBySeason;
import static com.jappstart.service.drop.EpisodeListUtilities.sortEpisodes;
...
public class TheTVDBClient extends AbstractEpisodeListProvider
{
    ...
    public List<Episode> getEpisodeList(SearchResult searchResult, Locale language) throws Exception
    {
        ...
        List<Episode> episodes = null;//cache.getEpisodeList(series.getSeriesId(), language);
    ...
    public URI getEpisodeListLink(SearchResult searchResult, int season)
    {
        ...
        try
        {
            Integer seasonId = null;//cache.getSeasonId(seriesId, season);
    ...
    public String getMirror(MirrorType mirrorType) throws Exception
    {
