...
<html>
    ...
    <section id="addRelease">
       		...
       		<div style="display:block;" id="addReleaseForm"> 
			    <form:form modelAttribute="add" action="/add" method="post" enctype="multipart/form-data">
	            <fieldset>     
	            	<div class="row">
		            ...
		            <div class="span6">
			            ...
			            <div class="clearfix">
			              <form:label for="netflixId" path="netflixId"><spring:message code="add.label.netflixId" /></form:label>
			              <div class="input">
